defmodule CaravelaSvelte.Reload do
  @moduledoc """
  ...
  When `config :caravela_svelte, vite_host: "http://localhost:5173"` is set, injects:
  ...
  ## Example
      ...
      <CaravelaSvelte.Reload.vite_assets assets={["/js/app.js"]}>
        <link phx-track-static rel="stylesheet" href={~p"/assets/app.css"} />
        <script defer phx-track-static type="text/javascript" src={~p"/assets/app.js"}>
        </script>
      </CaravelaSvelte.Reload.vite_assets>
  """
  def vite_assets(assigns) do
    vite_host = Application.get_env(:caravela_svelte, :vite_host)
