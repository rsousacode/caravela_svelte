defmodule CaravelaSvelte.Components do
  @moduledoc """
  ...
  defp name_to_function(name) do
    quote do
      def unquote(:"#{name}")(assigns) do
        # Extract slot assigns to pass through to CaravelaSvelte.svelte
        slot_assigns = CaravelaSvelte.Slots.filter_slots_from_assigns(assigns)
