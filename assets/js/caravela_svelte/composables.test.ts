/**
 * Unit tests for CaravelaSvelte composables.
...
describe("useCaravelaSvelte", () => {
  ...
  it("throws when context is not set", () => {
    ...
    expect(() => useCaravelaSvelte()).toThrow("useCaravelaSvelte()")
  })
...
describe("useLiveEvent", () => {
  it("throws when called outside CaravelaSvelte context", () => {
    vi.mocked(getContext).mockReturnValue(undefined)
