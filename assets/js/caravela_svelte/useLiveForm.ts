...
/**
 * Shape of the Phoenix.HTML.Form encoded by CaravelaSvelte.Encoder.
...
export function useLiveForm<T extends object>(
  ...
  // Graceful degradation: composable works without CaravelaSvelte context (SSR, tests without mock).
