/**
 * Public API type definitions for CaravelaSvelte.
...
/** Result of getHooks: CaravelaSvelteHook for LiveView hooks */
export interface CaravelaSvelteHooksResult {
  CaravelaSvelteHook: {
...
export type CaravelaSvelteRenderFn = (
  name: string,
...
export declare const getHooks: (components: ComponentModuleInput) => CaravelaSvelteHooksResult;
export declare const getRender: (
  components: ComponentModuleInput
) => CaravelaSvelteRenderFn;
 ...
 */
export declare function useCaravelaSvelte(): UseCaravelaSvelteResult;
 ...
 * Falls back to { connected: true } outside a CaravelaSvelte-mounted component.
 */
...
/**
 * Shape of a Phoenix.HTML.Form encoded by CaravelaSvelte.Encoder.
 ...
 * ```svelte
 * <script lang="ts">
 *   import { useLiveForm } from "caravela_svelte"
 ...
 * encoded by CaravelaSvelte.Encoder.
 */
...
/**
 * Shape of a Phoenix.LiveView.UploadConfig encoded by CaravelaSvelte.Encoder.
 ...
 * ```svelte
 * <script lang="ts">
 *   import { useLiveUpload } from "caravela_svelte"
 *   let { uploads } = $props()
...
export interface UseEventReplyReturn<T, P extends object | void = object> {
   ...
   * Rejects if already executing, if no CaravelaSvelte context, or if timeout expires.
   */
 ...
 * ```svelte
 * <script lang="ts">
 *   import { useEventReply } from "caravela_svelte"
