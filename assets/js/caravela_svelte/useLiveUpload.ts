 ...
 *
 * Binds to a Phoenix.LiveView.UploadConfig encoded by CaravelaSvelte.Encoder,
 ...
 *   import type { UploadConfig } from "caravela_svelte"
 *
...
import { useCaravelaSvelte } from "./composables"
...
export function useLiveUpload(
  ...
  // Graceful degradation: works without CaravelaSvelte context (SSR, tests without mock).
  let liveCtx: ReturnType<typeof useCaravelaSvelte> | null = null
  try {
    liveCtx = useCaravelaSvelte()
  } catch {
    // SSR or test without CaravelaSvelte context — pushEvent unavailable.
  }
